        ...
        return {
            ...
            menu : [
                ...
                },
                {
                    label: 'Katalog',
                    items: [
                        {label: 'Ürünler', icon: 'pi pi-fw pi-list', to: '/products'},
                        {label: 'Kategoriler', icon: 'pi pi-fw pi-book', to: '/categories'},
                        {label: 'Markalar', icon: 'pi pi-fw pi-circle-off', to: '/brands'}
                    ]
                },
				{
