			...
			<div class="card">
				...
				<Toolbar class="mb-4">
					<template v-slot:start>
						<div class="my-2">
							...
							<Button label="Sil" icon="pi pi-trash" class="p-button-danger mr-2" @click="confirmDeleteSelectedAll()" :disabled="!data.selectedBrands || !data.selectedBrands.length" />
				...
				<Dialog v-model:visible="data.deleteDialog" :style="{width: '450px'}" header="Bildirim" :modal="true">
					<div class="flex align-items-center justify-content-center">
						...
						<span v-if="data.brand"><b>{{data.brand.name}}</b> Kategoriyi silmek istediğinizden emin misiniz?</span>
					</div>
					<template #footer>
				...
				<Dialog v-model:visible="data.deleteDialogAll" :style="{width: '450px'}" header="Bildirim" :modal="true">
					<div class="flex align-items-center justify-content-center">
						<i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
						<span v-if="data.brand">Seçilen kategorileri silmek istediğinizden emin misiniz?</span>
					</div>
					<template #footer>
