                ...
                <div class="grid formgrid">
                    ...
                    <div class="col-12 mb-2 lg:col-12 lg:mb-0">
                        <div class="field">
                            ...
                            <MultiSelect display="chip" :filter="true" v-model="selectedCategory" :options="categories" optionLabel="name" placeholder="Ana Kategori" />
                        </div>
                    </div>
                    <div class="col-12 mb-2 lg:col-12 lg:mb-0">
                        <div class="field">
...
onMounted(() => {
    categoryService.getCategory(data.id).then(response => data.category = response);
});
...
const save = () => {
    ...
    if(data.category.name){
        ...
        categoryService.updateCategory(formData,data.id)
        .then((response) => {
            if(response.success){
