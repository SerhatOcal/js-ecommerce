        ...
        <Breadcrumb :home="data.home" class="mb-3"></Breadcrumb>
            <div class="card">
                ...
                <div class="grid formgrid">
                    ...
                    <div class="col-6 mb-2 lg:col-6 lg:mb-0 clear-fix" v-if="data.brand.image_name">
                        <div class="field">
                            <h6 for="status">Yüklü olan resim</h6>
                            <div class="card">
                                <Image :src="'http://localhost:3000/uploads/images/brands/' + data.brand.image_name" alt="Image" width="250" preview>
                                    <template #indicator>
                    ...
                    <div class="col-12 mb-2 lg:col-12 lg:mb-0 clear-fix">
                        <div class="formgroup-inline justify-content-end">
                            ...
                            <div class="field m-0 mr-2">
                                <Button label="Kaydet" icon="pi pi-check" class="p-button-outlined p-button-success mr-2 mb-2" :loading="data.loading" @click="save()"/>
                            </div>
                        </div>
                    </div>
                </div>
